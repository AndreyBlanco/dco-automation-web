...
GOOGLE_SHEET_NAME = "IVF-List-2026"
GOOGLE_WORKSHEET_NAME = "Testing May"

# Para probar seguro: deja TEST_LIMIT_PATIENTS = 3
# Cuando ya funcione bien, pon None
TEST_LIMIT_PATIENTS = None
...
def run_visible_day(page, ws, clinic_date):
    print("\n==============================")
    ...
    if TEST_LIMIT_PATIENTS is not None:
        appointments = appointments[:TEST_LIMIT_PATIENTS]
...
def main():
    ...
    with sync_playwright() as p:
        ...
        start_date_text = input("Fecha clínica inicial (YYYY-MM-DD): ").strip()
        days_count = int(input("Cuántos días seguidos quieres sacar?: ").strip())
        ...
        for day_number in range(days_count):
            ...
            run_visible_day(page, ws, clinic_date)
